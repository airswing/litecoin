...
#if defined(NDEBUG)
# error "Citadel cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Citadel Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s CTD additional fees, %d delta bytes\n",
