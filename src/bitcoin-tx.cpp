...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s citadel-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  citadel-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded citadel transaction") + "\n" +
              "  citadel-tx [options] -create [commands]   " + _("Create hex-encoded citadel transaction") + "\n" +
              "\n";
