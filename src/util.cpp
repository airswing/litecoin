...
const char * const BITCOIN_CONF_FILENAME = "citadel.conf";
const char * const BITCOIN_PID_FILENAME = "citadel.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Citadel";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Citadel";
#else
    // Unix
    return pathRet / ".citadel";
#endif
#endif
}
